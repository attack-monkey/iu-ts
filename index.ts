export function iu(state: any, subArray: string | any[], val: any) {
...
function reducer(_state: any, subArray: any[], val: any, l: number): any {
    try {
...
function stateWithoutKey(state: any, key: string) {
